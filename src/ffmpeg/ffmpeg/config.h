...
#define FFMPEG_CONFIGURATION "--cc=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc --as='gas-preprocessor.pl /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc' --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk --extra-ldflags=-L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk/usr/lib/system --target-os=darwin --arch=arm --cpu=cortex-a8 --extra-cflags='-I../x264 -arch armv7' --extra-ldflags='-L../x264 -arch armv7' --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-doc --disable-asm --enable-libx264 --enable-pic --enable-cross-compile --enable-gpl --enable-decoders --enable-encoders"
